...
class _FoodListScreenState extends State<FoodListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: buildStreamBuilderListFood(),
  ...
  StreamBuilder<List<Food>> buildStreamBuilderListFood() {
          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                Food f = _foodList[index];
                return buildSlidableListTile(f, context);
              },
            );
          } else {
            return Center(
  ...
  Slidable buildSlidableListTile(Food f, BuildContext context) {
    return Slidable(
      key: UniqueKey(),
